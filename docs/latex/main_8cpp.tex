...
\begin{DoxyCompactList}\small\item\em Programa principal que utiliza la calculadora. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Programa principal que utiliza la calculadora. 
